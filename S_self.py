...
#--------------------------------------------------------
                ...
                try:
                    ...
                    print url
                    cl.like(url['result']['posts'][0]['userInfo']['mid'], url['result']['posts'][0]['postInfo']['postId'], likeType=1002)
                    cl.comment(url['result']['posts'][0]['userInfo']['mid'], url['result']['posts'][0]['postInfo']['postId'], "Auto Like by A̸͟͞ C̸͟͞h̸͟͞i̸͟͞q̸͟͞a̸͟͞L̸͟͞F̸͟͞V̸͟͞")
